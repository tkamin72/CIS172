 ...
 */
 ...
 function setupDays() {
	var dates = document.getElementById("delivDy").etElementsByTagName("option");
...
13 				pass1Element.style.background = invColor;
14 			}
15 				if (pass2Element.value === "") {
16 					pass2Element.style.background = invColor;
17 				}
18 			}
19 			formValidity = false;
20 			}
}
